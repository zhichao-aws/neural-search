...
public class NeuralSparseQueryBuilder extends AbstractQueryBuilder<NeuralSparseQueryBuilder> implements ModelInferenceQueryBuilder {
    ...
    private static final Version MINIMAL_SUPPORTED_VERSION_ANALYZER = Version.V_2_17_0;
    ...
    public NeuralSparseQueryBuilder getCopyNeuralSparseQueryBuilderForTwoPhase(float ratio) {
        this.neuralSparseQueryTwoPhaseInfo = new NeuralSparseQueryTwoPhaseInfo(NeuralSparseQueryTwoPhaseInfo.TwoPhaseStatus.PARENT, ratio);
        NeuralSparseQueryBuilder copy = new NeuralSparseQueryBuilder().fieldName(this.fieldName)
            ...
            .neuralSparseQueryTwoPhaseInfo(new NeuralSparseQueryTwoPhaseInfo(NeuralSparseQueryTwoPhaseInfo.TwoPhaseStatus.CHILD, ratio));
    ...
    private Map<String, Float> getQueryTokens(QueryShardContext context) {
        if (Objects.nonNull(queryTokensSupplier) && !queryTokensSupplier.get().isEmpty()) {
            ...
            switch (neuralSparseQueryTwoPhaseInfo.getStatus()) {
                case CHILD:
                    return splitQueryTokensByRatioedMaxScoreAsThreshold(queryTokens, neuralSparseQueryTwoPhaseInfo.getTwoPhasePruneRatio())
                        .v2();
                case PARENT:
                    return splitQueryTokensByRatioedMaxScoreAsThreshold(queryTokens, neuralSparseQueryTwoPhaseInfo.getTwoPhasePruneRatio())
                        .v1();
